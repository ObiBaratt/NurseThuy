...
def blog():
    ...
    posts.reverse()
    return render_template("blog_index.html", all_posts=posts)
...
def edit_post(post_id):
    ...
    return render_template("make-post.html", form=edit_form, editing=True, current_user=current_user)
...
@admin_only
def delete(post_id):
    post_to_del = BlogPost.query.get(post_id)
